...
BeginPackage["HyperspectralChloroplastMovements`"];


(* ::Input::Initialization:: *)
readInHDRFileImages::"usage"="This function takes two arguments - the first is the path to the header (extension .hdr) of the hyperspectral image of the leaf, the second is the path to the header (.hdr) of the image used for dark calibration (an image recorded with the camera objective blocked by opaque material). The files with data saved in a binary form corresponding to the header, should be located in the same directory. If the second argument is not specified, the dark calibration is not performed.";
getImageData::"usage"="";
...
getImageDimensions::"usage"="Method of the hyperspectral image object. Returns the list with two elements: number of ";displayChloroplastMovementIndexHistogram::"usage"="Method of the hyperspectral image object. ";displayChloroplastMovementIndexImageCropped::"usage"="Method of the hyperspectral image object. Arguments: (1) the first, (2) the second row of the image to keep while cropping, (3) the first, (4) the second column of the image to keep while cropping. Arguments: Returns: a cropped image showing chloroplast movement index calculated for each pixel of the hyperspectral image. The image contains a legend showing the range color-coded values of chloroplast movement index.";displayChloroplastMovementIndexImageCroppedWithoutLegend::"usage"="Method of the hyperspectral image object. Method of the hyperspectral image object. Arguments: (1) the first, (2) the second row of the image to keep while cropping, (3) the first, (4) the second column of the image to keep while cropping. Arguments: Returns: a cropped image showing chloroplast movement index calculated for each pixel of the hyperspectral image. No legend is displayed.";displayChloroplastMovementIndexImageCroppedWithoutLegendAndBackground::"usage"="Method of the hyperspectral image object. ";
...
displayImageByIndex::"usage"="Method of the hyperspectral image object. Arguments: (1) the index of the image (along the spectral direction). Returns: an image for a single wavelength value, corresponding to the specified index.";displayImageByIndexCustomNormalized::"usage"="Method of the hyperspectral image object. ";getImageDataByWavelength::"usage"="Method of the hyperspectral image object. Arguments: (1) wavelength in nanometers. Returns a matrix of image values corresponding to the specified wavelength.";displayImageDataByWavelength::"usage"="Method of the hyperspectral image object. Arguments: (1) wavelength in nanometers. Returns an image corresponding to the specified wavelength";displayImageDataByWavelengthCustomNormalized::"usage"="Method of the hyperspectral image object. ";extractSpectrumWithinRegion::"usage"="Method of the hyperspectral image object. ";extractMeanSpectrumWithinWholeImage::"usage"="Method of the hyperspectral image object. ";extractSpectraWithinWholeImage::"usage"="Method of the hyperspectral image object. ";extractMeanSpectrumWithinRegionWithoutDarkCalibration::"usage"="Method of the hyperspectral image object. ";extractMeanSpectrumWithinRegion::"usage"="Method of the hyperspectral image object. Arguments: (1) the region (usually a Disk or Polygon, can be other object for which the Mathematica built-in command RegionQ returns True) of the image area for which spectrum is required. Returns a list of mean image values for each wavelength.";extractReflectanceWithinRegionUsingWhiteReferenceRegionWithoutDarkCalibration::"usage"="Method of the hyperspectral image object. ";extractReflectanceWithinRegionUsingWhiteReferenceRegion::"usage"="Method of the hyperspectral image object. Arguments: (1) the region (usually a Disk or Polygon, can be other object for which the Mathematica built-in command RegionQ returns True) of the image area for which reflectance is required, (2) the region occupied by the 100% reflectance standard. Returns a list of mean image values for each wavelength, normalized by the values calculated for the reference region.";extractReflectanceWithinRegionUsingWhiteReferenceCurve::"usage"="Method of the hyperspectral image object. Arguments: (1) the region (usually a Disk or Polygon, can be other object for which the Mathematica built-in command RegionQ returns True) of the image area for which reflectance spectrum is required, (2) the curve showing absolute spectrum of light reflected from 100% reflectance standard. Returns a list of mean image values for each wavelength, normalized by the values calculated for the reference region.";extractDifferenceInReflectanceBetweenRegionsUsingReferenceWithoutDarkCalibration::"usage"="Method of the hyperspectral image object. ";extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceRegion::"usage"="Method of the hyperspectral image object. Arguments: (1) the first region (region A; usually a Disk or Polygon, can be other object for which the Mathematica built-in command RegionQ returns True) of the image area to use in calculation of reflectance, (2) the second region (region B), (3) he region occupied by the 100% reflectance standard. Returns: a curve showing difference in reflectance between region B and A (B minus A).";extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceCurve::"usage"="Method of the hyperspectral image object. Arguments: (1) the first region (region A; usually a Disk or Polygon, can be other object for which the Mathematica built-in command RegionQ returns True) of the image area to use in calculation of reflectance, (2) the second region (region B), (3) the curve showing absolute spectrum of light reflected from 100% reflectance standard. Returns: a curve showing difference in reflectance between region B and A (B minus A).";extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceCurveWithCalibration::"usage"="Method of the hyperspectral image object. ";extractDifferenceInMeanSpectrumBetweenRegionsWithRespectToTwoReferences::"usage"="Method of the hyperspectral image object. ";extractDifferenceInReflectanceBetweenRegionsUsingTwoWhiteReferenceRegions::"usage"="Method of the hyperspectral image object. ";
...
getImageDataByIndex="getImageDataByIndex";getImageDimensions="getImageDimensions";displayChloroplastMovementIndexHistogram="displayChloroplastMovementIndexHistogram";displayChloroplastMovementIndexImageCropped="displayChloroplastMovementIndexImageCropped";displayChloroplastMovementIndexImageCroppedWithoutLegend="displayChloroplastMovementIndexImageCroppedWithoutLegend";displayChloroplastMovementIndexImageCroppedWithoutLegendAndBackground="displayChloroplastMovementIndexImageCroppedWithoutLegendAndBackground";
getVISReflectanceImage="getReflectanceImage";
displayVISReflectanceImage="displayVISReflectanceImage";
displayVISReflectanceImageCropped="displayVISReflectanceImageCropped";displayReflectanceImageCropped="displayReflectanceImageCropped";displayNDVImageCropped="displayNDVImageCropped";displayImageByIndex="displayImageByIndex";displayImageByIndexCustomNormalized="displayImageByIndexCustomNormalized";getImageDataByWavelength="getImageDataByWavelength";displayImageDataByWavelength="displayImageDataByWavelength";displayImageDataByWavelengthCustomNormalized="displayImageDataByWavelengthCustomNormalized";extractSpectrumWithinRegion="extractSpectrumWithinRegion";extractMeanSpectrumWithinWholeImage="extractMeanSpectrumWithinWholeImage";extractSpectraWithinWholeImage="extractSpectraWithinWholeImage";extractMeanSpectrumWithinRegionWithoutDarkCalibration="extractMeanSpectrumWithinRegionWithoutDarkCalibration";extractMeanSpectrumWithinRegion="extractMeanSpectrumWithinRegionWithDarkCalibration";extractReflectanceWithinRegionUsingWhiteReferenceRegionWithoutDarkCalibration="extractReflectanceWithinRegionUsingWhiteReferenceRegionWithoutDarkCalibration";extractReflectanceWithinRegionUsingWhiteReferenceRegion="extractReflectanceWithinRegionUsingWhiteReferenceRegion";extractReflectanceWithinRegionUsingWhiteReferenceCurve="extractReflectanceWithinRegionUsingWhiteReferenceCurve";extractDifferenceInReflectanceBetweenRegionsUsingReferenceWithoutDarkCalibration="extractDifferenceInReflectanceBetweenRegionsUsingReferenceWithoutDarkCalibration";extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceRegion="extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceRegion";extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceCurve="extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceCurve";extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceCurveWithCalibration="extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceCurveWithCalibration";extractDifferenceInMeanSpectrumBetweenRegionsWithRespectToTwoReferences="extractDifferenceInMeanSpectrumBetweenRegionsWithRespectToTwoReferences";extractDifferenceInReflectanceBetweenRegionsUsingTwoWhiteReferenceRegions="extractDifferenceInReflectanceBetweenRegionsUsingTwoWhiteReferenceRegions";
...
displayImageDataByWavelength->((Image[getImageForWavelengthWithoutInterpolation[imagesData,wavelengthsInNanometers,bandCount,sampleCount,#1]/4095.,ColorSpace->"Grayscale"])&),displayImageDataByWavelengthCustomNormalized->((Image[getImageForWavelengthWithoutInterpolation[imagesData,wavelengthsInNanometers,bandCount,sampleCount,#1]/#2,ColorSpace->"Grayscale"])&),extractSpectrumWithinRegion->(extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#,sampleCount,lineCount]&),extractMeanSpectrumWithinWholeImage->(calculateMeansOfSpectra[extractSpectrum[imagesData,wavelengthsInNanometers,sampleCount,lineCount]]&),extractSpectraWithinWholeImage->(extractSpectrum[imagesData,wavelengthsInNanometers,sampleCount,lineCount]&),extractMeanSpectrumWithinRegionWithoutDarkCalibration->(calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#,sampleCount,lineCount]]&),extractMeanSpectrumWithinRegion->(Quiet[calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#,sampleCount,lineCount,darkCalibrationData]]]&),extractReflectanceWithinRegionUsingWhiteReferenceRegionWithoutDarkCalibration->(With[{meansRegionOfInterest=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount]],meansReference=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#2,sampleCount,lineCount]]},Table[{meansRegionOfInterest[[i,1]],meansRegionOfInterest[[i,2]]/meansReference[[i,2]]},{i,2,Length[meansRegionOfInterest]}]]&),extractReflectanceWithinRegionUsingWhiteReferenceRegion->(With[{meansRegionOfInterest=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount,darkCalibrationData]],meansReference=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#2,sampleCount,lineCount,darkCalibrationData]]},Table[{meansRegionOfInterest[[i,1]],meansRegionOfInterest[[i,2]]/meansReference[[i,2]]},{i,2,Length[meansRegionOfInterest]}]]&),extractReflectanceWithinRegionUsingWhiteReferenceCurve->(With[{meansRegionOfInterest=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount,darkCalibrationData]],referenceFunction=Interpolation[#2]},Table[{meansRegionOfInterest[[i,1]],meansRegionOfInterest[[i,2]]/referenceFunction[meansRegionOfInterest[[i,1]]]},{i,2,Length[meansRegionOfInterest]}]]&),extractDifferenceInReflectanceBetweenRegionsUsingReferenceWithoutDarkCalibration->(With[{meansRegionOfInterestA=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount]],meansRegionOfInterestB=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#2,sampleCount,lineCount]],meansReference=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#3,sampleCount,lineCount]]},Table[{meansRegionOfInterestA[[i,1]],(meansRegionOfInterestA[[i,2]]-meansRegionOfInterestB[[i,2]])/meansReference[[i,2]]},{i,2,Length[meansRegionOfInterestA]}]]&),extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceRegion->(With[{meansRegionOfInterestA=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount,darkCalibrationData]],meansRegionOfInterestB=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#2,sampleCount,lineCount,darkCalibrationData]],meansReference=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#3,sampleCount,lineCount,darkCalibrationData]]},Table[{meansRegionOfInterestA[[i,1]],(meansRegionOfInterestA[[i,2]]-meansRegionOfInterestB[[i,2]])/meansReference[[i,2]]},{i,2,Length[meansRegionOfInterestA]}]]&),extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceCurve->((With[{meansRegionOfInterestA=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount]],meansRegionOfInterestB=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#2,sampleCount,lineCount]],referenceFunction=Interpolation[#3]},Table[{meansRegionOfInterestA[[i,1]],(meansRegionOfInterestA[[i,2]]-meansRegionOfInterestB[[i,2]])/referenceFunction[meansRegionOfInterestA[[i,1]]]},{i,2,Length[meansRegionOfInterestA]}]])&),extractDifferenceInReflectanceBetweenRegionsUsingWhiteReferenceCurveWithCalibration->((With[{meansRegionOfInterestA=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount,darkCalibrationData]],meansRegionOfInterestB=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#2,sampleCount,lineCount,darkCalibrationData]],referenceFunction=Interpolation[#3]},Table[{meansRegionOfInterestA[[i,1]],(meansRegionOfInterestA[[i,2]]-meansRegionOfInterestB[[i,2]])/referenceFunction[meansRegionOfInterestA[[i,1]]]},{i,2,Length[meansRegionOfInterestA]}]])&),extractDifferenceInMeanSpectrumBetweenRegionsWithRespectToTwoReferences->((With[{meansRegionOfInterestA=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount]],meansRegionOfInterestB=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#2,sampleCount,lineCount]],meansReferenceA=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#3,sampleCount,lineCount]],meansReferenceB=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#4,sampleCount,lineCount]]},Table[{meansRegionOfInterestA[[i,1]],meansRegionOfInterestA[[i,2]]/meansReferenceA[[i,2]]-meansRegionOfInterestB[[i,2]]/meansReferenceB[[i,2]]},{i,2,Length[meansRegionOfInterestA]}]])&),extractDifferenceInReflectanceBetweenRegionsUsingTwoWhiteReferenceRegions->((With[{meansRegionOfInterestA=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#1,sampleCount,lineCount,darkCalibrationData]],meansRegionOfInterestB=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#2,sampleCount,lineCount,darkCalibrationData]],meansReferenceA=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#3,sampleCount,lineCount,darkCalibrationData]],meansReferenceB=calculateMeansOfSpectra[extractSpectrumWithinRegionPrivate[imagesData,wavelengthsInNanometers,#4,sampleCount,lineCount,darkCalibrationData]]},Table[{meansRegionOfInterestA[[i,1]],meansRegionOfInterestA[[i,2]]/meansReferenceA[[i,2]]-meansRegionOfInterestB[[i,2]]/meansReferenceB[[i,2]]},{i,2,Length[meansRegionOfInterestA]}]])&)]]]
...
(* ::Input::Initialization:: *)
getIndexOfWavelength[wavelengthInNanoMeters_?NumericQ]:=BinarySearch[wavelengths,wavelengthInNanoMeters]


(* ::Input::Initialization:: *)
getIndexOfWavelength[wavelengths_List,wavelengthInNanoMeters_?NumericQ]:=BinarySearch[wavelengths,wavelengthInNanoMeters]
