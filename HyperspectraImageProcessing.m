...
displayImageDataByWavelengthCustomNormalized::"usage"="Method of the hyperspectral image object. ";
...
classifyChloroplastResponse->(With[{differenceSpectrum=self[extractDifferenceInReflectenceSpectrum][#1,#2,#3]}]&)]]]
